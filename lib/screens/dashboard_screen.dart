...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
 ...
 Widget _buildNotConnectedUI() {
  ...
  Widget _buildStatisticsSection(SensorProvider sensorProvider, AirQualityProvider airQualityProvider) {
    final status = _getAqiStatus(sensorProvider.airQuality.toDouble());
    final aqi = sensorProvider.airQuality.toInt(); // LIVE VALUE
    final aqiColor = _getAqiColor(aqi.toDouble());
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Center(
        ...
        const SizedBox(height: 24),
       if (airQualityProvider.forecastData.isNotEmpty)
          AirQualityForecastCard(
            currentAqi: aqi, // Pass the live AQI here
